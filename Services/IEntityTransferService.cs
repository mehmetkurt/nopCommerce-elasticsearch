...
public interface IEntityTransferService
{
    ...
    Task<ImmutableList<TEntity>> GetNonTransferredEntitiesAsync<TEntity>(int pageIndex = 0, int pageSize = int.MaxValue, bool getOnlyTotalCount = false) where TEntity : BaseEntity;
